...
let AppModule = class AppModule {
    constructor(platformId, appId) {
        ...
        this.appId = appId;
        const platform = Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["isPlatformBrowser"])(platformId) ?
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2dlbmVyYXRlLWludm9pY2UvZ2VuZXJhdGUtaW52b2ljZS5jb21wb25lbnQuY3NzIn0= */"
...
let GenerateInvoiceComponent = class GenerateInvoiceComponent {
    constructor(platformId, appId, localStorageService) {
        this.platformId = platformId;
        this.appId = appId;
  ...
  `;
        ...
        pdf.save('test.pdf');
        // var printContent = document.getElementById('main-invoice-part');
...
let GetPdfComponent = class GetPdfComponent {
    constructor() { }
    ngOnInit() {
    }
    downloadPdf() {
        const doc = new jspdf__WEBPACK_IMPORTED_MODULE_2__();
        let content = `
...
/* harmony import */ var ngx_device_detector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-device-detector */ "./node_modules/ngx-device-detector/fesm2015/ngx-device-detector.js");
...
let LocalStorageService = class LocalStorageService {
    constructor(platformId, appId, deviceService, cookieService, globals) {
        this.platformId = platformId;
        this.appId = appId;
